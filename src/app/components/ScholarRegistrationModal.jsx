...
export default function ScholarRegistrationModal({ isOpen, onClose, onOpenPrivacyModal }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('/api/register', {
        ...
        body: JSON.stringify({ username, password, displayName, barangay })
      });
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 flex flex-col gap-4 font-sans overflow-y-auto">
          ...
          <div className="p-2.5 bg-white/[0.03] border border-white/5 rounded-lg flex items-start gap-2 text-[10px] text-white/50">
            ...
            <p className="leading-tight">
              By creating your student account, you agree to our{' '}
              <button
                type="button"
